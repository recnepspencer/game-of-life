...
const GameCanvas4p: React.FC = () => {
  ...
  const handleSaveGrid = async () => {
    try {
      const response = await fetch('/api/test-game-object/send-game-object-4p', {  // This should match the file name in your pages/api directory
        method: 'POST',
        headers: {
